...
export const PROD_BACKEND_URL = "https://camp-nft-backend-production.up.railway.app";
export const GRAPHQL_URL = "https://camp.andithemudkip.com/subgraphs/name/camp-nft-app";
export const WS_GRAPHQL_URL = "wss://camp.andithemudkip.com/subgraphs/name/camp-nft-app";
