...
export const GRAPHQL_URL = "http://165.227.151.208:8000/subgraphs/name/camp-nft-app";
export const WS_GRAPHQL_URL = "ws://165.227.151.208:8001/subgraphs/name/camp-nft-app";
